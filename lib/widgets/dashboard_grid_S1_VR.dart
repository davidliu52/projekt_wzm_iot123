...
class DashboardS1VRGrid extends StatefulWidget {

  @override
  State<DashboardS1VRGrid> createState() => _DashboardS1vrGridState();
}

class _DashboardS1vrGridState extends State<DashboardS1VRGrid> {
            ...
            children: [
              ...
              Container(
                ...
                child: const SizedBox(
                  height: 10,
                  child: Center(
                    child: Text('Sensor 1', style: TextStyle(fontSize: 5, fontWeight: FontWeight.bold)
                    ),
                  ),
                ),
              ),
              ...
              Container(
                ...
                child: SfCartesianChart(
                  ...
                  primaryXAxis: DateTimeAxis(
                      ...
                      title: AxisTitle(text: 'Zeit [s]',  textStyle: TextStyle(fontSize: 3,color: Colors.black))
                  ),
                  primaryYAxis: NumericAxis(
                      ...
                      title: AxisTitle(text: 'Values [g]',  textStyle: TextStyle(fontSize: 3,color: Colors.black))
                  ),
