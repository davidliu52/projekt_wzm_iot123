...
class DashboardM1VRGrid extends StatefulWidget {

  @override
  State<DashboardM1VRGrid> createState() => _DashboardM1VRGridState();
}

class _DashboardM1VRGridState extends State<DashboardM1VRGrid>  {
       ...
       height:50,
        ...
        primaryYAxis: NumericAxis(
            ...
            title: AxisTitle(text: 'PWM Signal [Hz]',
                textStyle: const TextStyle(fontSize: 3,color: Colors.black))
          ),
      ...
      return Container(
          ...
          child: SfCartesianChart(
            ...
            primaryXAxis: DateTimeAxis(
                ...
                interval: 1,
                labelStyle: const TextStyle(fontSize: 3,color: Colors.black),
            ),
            primaryYAxis: NumericAxis(
                axisLine: const AxisLine(width: 0.1, color: Colors.black),
                majorGridLines: const MajorGridLines(width: 0.1),
...
// ---------A standalone widget just for displaying a  Radial Gauge Chart for the PWM values-----------
    ...
    Widget buildPWM_gauges(){
      return Container(
          ...
          SfRadialGauge(
            axes: <RadialAxis>[
              RadialAxis(minimum: 0, maximum: 300,  interval: 50,  labelOffset:3,
                ...
                annotations: <GaugeAnnotation>[
                  ...
                  children: <Widget>[
                    Text(_pwm_frequency.toString(), style: const TextStyle(fontSize: 3, fontWeight: FontWeight.bold),),
                    const SizedBox(height: 5,),
                    const Text('Hz', style: TextStyle(fontSize: 3, fontWeight: FontWeight.bold),)
                  ],
            ...
            axes: <RadialAxis>[
              RadialAxis(minimum: 0, maximum: 300,  interval: 50,  labelOffset:3,// <-- Add this line
                ...
                annotations: <GaugeAnnotation>[
                  GaugeAnnotation(widget: Column(
                    children: <Widget>[
                      Text(_speed.toString(), style: const TextStyle(fontSize: 3, fontWeight: FontWeight.bold),),
                      const SizedBox(height: 5,),
                      const Text('rpm', style: TextStyle(fontSize: 3, fontWeight: FontWeight.bold),)
                    ],
                  ), angle: 90, positionFactor: 1.5, )],
              ),
            ],
        ...
        children: <Widget>[
          Container(
            ...
            child: const SizedBox(
                height: 10,
                 child: Center(
                    child: Text('Motor 1', style: TextStyle(fontSize: 5, fontWeight: FontWeight.bold)
                ),
              ),
            ),
          ),
