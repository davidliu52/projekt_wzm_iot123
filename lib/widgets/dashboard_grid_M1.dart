...
//DashboardM1Grid is an independent class, solely for displaying the chart.

class DashboardM1Grid extends StatefulWidget {
  const DashboardM1Grid({super.key});
  @override
  State<DashboardM1Grid> createState() => _DashboardM1GridState();
}

class _DashboardM1GridState extends State<DashboardM1Grid>  {
  Map<String, dynamic> pt = {};
  late List<LiveData> chartData;
  late ChartSeriesController _chartSeriesController;
  Timer? _updateTimer;
  Timer? _dataReadTimer;
  final client = mqttsetup.setup('10.22.40.248', 'unieID', 1883);
...
//---------initialize the parameter-----------
  ...
  double _speed = 0;
  String _currentPage = DashboardM1Page.pageName;
  ...
  _DashboardM1GridState() {
    if(_currentPage == DashboardM1Page.pageName) {
    ...
    Widget Timeserieschart_pwm() {
      ...
      child: SfCartesianChart(
        ...
        primaryXAxis: DateTimeAxis(
            ...
            interval: 1,
            title: AxisTitle(text: 'Zeit [s]',   textStyle: const TextStyle(fontSize: 15))
        ),
...
//--------------Displaying all the information related to Motor1, It includes five main container--------
    ...
    return Column(
      children: <Widget>[
        ...
        //-----------The second container displays the status of two parameters of Motor1 (System State, Test Running).
       ...
       const SizedBox(height: 10,),
        ...
        //----------The fourth container displays two Time Series Line Charts, which may be arranged in a column or row, depending on the value of isPortrait.----------
